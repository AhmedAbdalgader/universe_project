...
CREATE TABLE public.moon (
    ...
    name character varying(50) NOT NULL,
    age_in_millions_of_years integer,
    self_axis_rotation_in_day integer NOT NULL,
    distance_from_earth numeric,
...
--
-- Name: star galaxy_star_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.star
    ADD CONSTRAINT galaxy_star_id_fkey FOREIGN KEY (galaxy_id) REFERENCES public.galaxy(galaxy_id);
